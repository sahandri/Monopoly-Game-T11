...
public class TestRailroad {
    ...
    public void testPerform(){
        ...
        assertEquals(1300, player1.getMoney().money); //testing to buy a railroad
        ...
        assertEquals(1475, player2.getMoney().money); //testing to pay rent for one railroad

        board.getSquares()[15].perform(player1,board); //player 1 buys second railroad
        assertEquals(1100, player1.getMoney().money); //testing to buy a railroad
        ...
        assertEquals(1425, player2.getMoney().money); //testing to pay rent for two railroads
        ...
        assertEquals(1425, player2.getMoney().money); //testing to not buy the railroad
    }
